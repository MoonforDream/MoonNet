...
// @see
// https://github.com/chenshuo/muduo/blob/master/muduo/net/EventLoopThread.h and
// https://github.com/chenshuo/muduo/blob/master/muduo/net/EventLoopThread.cc
...
namespace moon {
    ...
    public:
        loopthread(int timeout = -1)
            : loop_(nullptr),
              t_(std::thread(&loopthread::_init_, this)),
              timeout_(timeout) {
